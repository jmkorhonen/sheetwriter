...
Open: preserving Excel cell colours and comments on chapter sheets across saves (needs row identity that survives Excel edits), Firefox and Safari checks, a mobile layout, releases with a forced-download asset.
